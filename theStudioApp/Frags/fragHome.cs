...
namespace theStudioApp
{
    public class fragHome : Fragment
    {
        public override void OnCreate(Bundle svaedInstanceState)
        {
            ...
            Toast.MakeText(Context.ApplicationContext, "fragHome oncreate has been run", ToastLength.Short).Show();
        }

        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle svaedInstanceState)
        {
            return inflater.Inflate(Resource.Layout.layoutHome, container, false);
